...
public class CompoundInterest {
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        int till = numYears(targetYear);
        double the_shiznit = perYear;

        while (till > 0 ){

            the_shiznit *= (1+rate/100);
            the_shiznit += perYear;
            till-=1;
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        return the_shiznit * Math.pow(1-inflationRate/100, numYears(targetYear)); */
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = futureValue(1,10,2059); // replace 0 with your code
        double realDollarValue = futureValueReal(1,10,2059,3);    // replace 0 with your code
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = totalSavings(10000,2059,10); // replace 0 with your code
        double realSavings = totalSavingsReal(10000,2059,10,3);    // replace 0 with your code
